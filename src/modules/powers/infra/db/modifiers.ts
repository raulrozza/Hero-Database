  ...
  [
    'Attack',
    {
      ...
      description: [
        ...
        'The effect no longer works on you (so a Teleport Attack can’t be used to teleport yourself, for example). It affects one creature of any size or 50 lbs. of inanimate mass. The effect has close range and requires a standard action and an attack check to touch the subject. Its range can be improved with the @{Modifier|Range} extra while its required action can be changed with the @{Modifier|Action} modifier. The target gets a resistance check, determined when the effect is made into an attack. Generally @{Resistance|Dodge} or @{Resistance|Will} is the most appropriate. A successful check negates the effect.',
