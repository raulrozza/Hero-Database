...
export const advantages = new Map<string, MetaAdvantage>([
  ...
  [
    'Grabbing Finesse',
    {
      ...
      type: 'combat',
      description: [
        'You can use your @{Skill|Dexterity} bonus, rather than your @{Ability|Strength} bonus, to make grab attacks. You are not @{Condition|Vulnerable|vulnerable} while grabbing. See @{Action|Grab}, for details. This is a good advantage for skilled unarmed combatants focused more on speed than strength.',
      ],
      maxRanks: 1,
      source: 'HH',
    },
